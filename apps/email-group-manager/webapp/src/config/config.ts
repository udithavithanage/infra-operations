...
export const AppConfig = {
  serviceUrls: {
    ...
    userGroups: ServiceBaseUrl + "/user-google-groups",
    allGroups: ServiceBaseUrl + "/all-google-groups",
    subscribe: ServiceBaseUrl + "/google-group/subscribe",
    unsubscribe: ServiceBaseUrl + "/google-group/unsubscribe",
    defaultGroups: ServiceBaseUrl + "/default-google-groups",
    publicGroups: ServiceBaseUrl + "/public-google-groups",
    privateGroups: ServiceBaseUrl + "/private-google-groups",
  },
};
